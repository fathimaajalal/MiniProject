...
function checkRegnoAvailability() {
  ...
  xhr.open('POST', 'check_regno.php', false); // Use synchronous request for simplicity
     ...
     <form onsubmit="return validateForm()" action="register_database.php" method="POST" >
        <div class="main-user-info">
          ...
          <div class="user-input-box">
                ...
                <input type="text" id="regno" name="regno" placeholder="Eg., 22UBC129" required>
