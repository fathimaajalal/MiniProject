<?php
session_start();
unset($_SESSION['submission_success']); // Clear session variable after displaying the success message
?>
...
<div class="container">
        ...
        <a href="seller_page.php?clear=true">Submit Another Product</a>
    </div>
</body>
</html>
